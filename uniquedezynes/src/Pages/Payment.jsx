import { Box, Container, Flex, HStack, Heading, Text,Button ,VStack,Accordion,
    AccordionItem,
    AccordionButton,
    AccordionPanel,
    List,
    ...
    <Text color={"gray.600"} fontSize={"13px"}>10% Cashback upto Rs 150 on FreeCharge PayLater transaction. TCA</Text>
          ...
          <Box w="37%" >
           <Flex  justifyContent={"space-between"} flexDirection={"column"}>
            ...
            <Flex alignItems={"center"}>
               <CiStar/>
               <Heading  ml="3px"  size={"xs"}>Recommended</Heading>
            </Flex>
            </Box>
            ...
            <Flex alignItems={"center"}>
               <GiMoneyStack/>
               <Heading  ml="3px"  size={"xs"}>Cash on Delivery</Heading>
            </Flex>
            </Box>
            ...
            <Flex alignItems={"center"}>
               <BsCreditCard2Back/>
               <Heading  ml="3px"  size={"xs"}>Credit/Debit Card</Heading>
            </Flex>
            </Box>

            <Box p="10px">
            <Flex alignItems={"center"}>
               <Text fontSize={"10px"} border={"1px solid black"} h="14px"  >UPI</Text>
               <Heading ml="3px" size={"xs"}>PhonePe/Google Pay/BHIM UPI</Heading>
            </Flex>
            </Box>
          ...
          <Box p="10px">
            <Flex alignItems={"center"}>
               <GiWallet/>
               <Heading  ml="3px"  size={"xs"}>Paytm/Wallets</Heading>
            </Flex>
          </Box>
            ...
            <Flex alignItems={"center"}>
               <BsBank/>
               <Heading  ml="3px"  size={"xs"}>Net Banking</Heading>
            </Flex>
            ...
            <Flex alignItems={"center"}>
               {/* <GiMoneyStack/> */}
               <BsTerminalDash/>
               <Heading  ml="3px"  size={"xs"}>EMI/Pay Later</Heading>
            </Flex>
            </Box>
          ...
          <Box color={"gray.700"} mt="10px" p="20px" borderRadius={"3px"} border={"1px solid #C1D0B5"}>
